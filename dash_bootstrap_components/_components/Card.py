...
- body (boolean; optional):
    ...
    to also  include a CardBody component in the children of this
    Card. Default: False.
...
- color (string; optional):
    ...
    danger,  light, dark or any valid CSS color of  your choice (e.g.
    a hex code, a decimal code or a CSS color name).  Default is
    light.
